        ...
        btnDelete.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Integer deletedRows = myDb6.deleteData(editTextId.getText().toString());
                        if(deletedRows > 0)
                            Toast.makeText(Semester6Activity.this,"Data Deleted",Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(Semester6Activity.this,"Data not Deleted",Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
    public void UpdateData() {
        btnviewUpdate.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        boolean isUpdate = myDb6.updateData(editTextId.getText().toString(),
                        ...
                        if(isUpdate == true)
                            Toast.makeText(Semester6Activity.this,"Data Update",Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(Semester6Activity.this,"Data not Updated",Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
    public  void AddData() {
        btnAddData.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        boolean isInserted = myDb6.insertData(editSemester.getText().toString(),
                                ...
                                editLec.getText().toString() );
                        if(isInserted == true)
                            Toast.makeText(Semester6Activity.this,"Data Inserted",Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(Semester6Activity.this,"Data not Inserted",Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
