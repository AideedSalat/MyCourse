...
public class UpdateSemTest {
    ...
    public void updateSemTest() {
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.editText_prac),
                        childAtPosition(
                                ...
                                14),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("66"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.editText_exam),
                        childAtPosition(
                                ...
                                18),
                        isDisplayed()));
        appCompatEditText9.perform(replaceText("75"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText11 = onView(
                allOf(withId(R.id.editText_module1), withText("Ken"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                21),
                        isDisplayed()));
        appCompatEditText11.perform(replaceText("Nyanjui"));

        ViewInteraction appCompatEditText12 = onView(
                allOf(withId(R.id.editText_module1), withText("Nyanjui"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
